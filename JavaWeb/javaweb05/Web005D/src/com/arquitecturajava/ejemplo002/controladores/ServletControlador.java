...
public class ServletControlador extends HttpServlet {
	...
	protected void procesarPeticion(HttpServletRequest request, HttpServletResponse response)
		...
		if (accion.equals("lista")) { // ref solucion url ServletControlador

			miaccion = new ListaCursosAccion(); // nueva clase con la acción de
												// listar lo q tenemos
			miaccion.ejecutar(request, response); // interface
